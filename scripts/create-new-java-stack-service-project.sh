...
HELP=
VERBOSE=
PROJECT_NAME=java-stack-service
...
main() {
  SUBPROJECTS_DIR="model/project/subprojects/laplacian-arch"
...
#   source_repository:
#     url: https://github.com/laplacian-arch/$PROJECT_NAME.git
EOF
}
...
show_usage () {
cat << 'END'
Usage: ./scripts/create-new-java-stack-service-project.sh [OPTION]...
  -h, --help
    Displays how to use this command.
  -v, --verbose
    Displays more detailed command execution information.
  --project-name [VALUE]
    New project's name (Default: java-stack-service)
  --project-version [VALUE]
    The initial version number (Default: 0.0.1)
  --namespace [VALUE]
    Namespace (Default: laplacian.arch)
END
}
